...
namespace MVVM.Core
{
    ...
    public class TestVM : MVVMViewModel<TestModel>
    {
        public static TestVM Instance
        {
            get { return _instance ?? (_instance = new TestVM()); }
        }
        private static TestVM _instance;

        protected override TestModel CreateModel() => new TestModel();
    }
}